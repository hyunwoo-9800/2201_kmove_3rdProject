				...
				<div class="submain-wrapper" style="">
					...
					<div class="submain-wrapper">
						...
						<div id="_core_content_wrapper_">
							<ul class="category">
								<li class="tab_on" onclick="location.href='/board/schoolinfo'">教会学校紹介
								</li>
								<li class="tab_off" onclick="location.href='/board/list?type=6'">教会学校掲示板
								</li>
							</ul>
							...
							<div class="content-wrap">
									...
									<div class="flex-container">
										<div class="flex-item">
											<a href="/board/infomation"><img alt="menu1"
												src="/resources/img/gakkou1.jpg" width="433" height="300"></a>
										</div>
										<div class="flex-item">
											<a href="/board/list?type=1"><img alt="menu2"
												src="/resources/img/gakkou2.jpg" width="433" height="300"></a>
										</div>
										<div class="flex-item">
											<a href="/board/gil"><img alt="menu3"
												src="/resources/img/gakkou3.jpg" width="433" height="300"></a>
										</div>
									</div>
								...
								<table class="basic-table"
									...
									<tr>
										<th>標語</th>
										<td>完全なキリスト教徒に育っていく私たち</td>
									</tr>
									<tr>
										<th>聖句</th>
										<td>また， 幼いころから 聖書に 親しんで 來たことを 知っているからです。 聖書はあなたに 知惠を 與えて
											キリスト · イエス に 對する 信仰による 救いを 受けさせることができるのです。</td>
									</tr>
								</table>
								</div>
