...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <form role="form" action="/admin/admin_update" method="post">
...
<div class="form-group">
  <!-- <label>番号</label>  -->
  <input type="hidden" class="form-control" name='bango' 
...
<div class="form-group">
  ...
  <input class="form-control" name='namae'
    value='<c:out value="${member.namae}"/>'>            
</div>

<div class="form-group">
  <label>誕生日</label> 
  <input class="form-control" name='tannjyoubi'
    value='<c:out value="${member.tannjyoubi}"/>'>              
</div>

<div class="form-group">
  <label>メール</label> 
  <input class="form-control" name='mail'
    value='<c:out value="${member.mail}"/>'>              
</div>

<div class="form-group">
  <label>電話番号</label> 
  <input class="form-control" name='dennwabanngo'
    value='<c:out value="${member.dennwabanngo}"/>'>              
</div>
...
<option value='<c:out value="ROLE_ADMIN"/>'>管理者</option>
<option value='<c:out value="ROLE_USER"/>'>一般</option>
</select>
</div>   
